...
export type LegendaryAnalysisResponse = ScanInsightResponse | ComebackWeaponResponse | PatternProfilingResponse;
export declare enum LegendaryManipulationTactics {
...
export declare enum ComebackStyleArchetypes {
    CLIPPED = "clipped",
    ONE_LINER = "one_liner",
...
export declare enum LegendaryComebackTones {
    MATURE = "mature",
    SAVAGE = "savage",
    PETTY = "petty",
    PLAYFUL = "playful"
}
export declare enum LegendaryManipulatorTypes {
...
export declare enum RelationshipContexts {
    PARTNER = "Partner",
    EX = "Ex",
    DATE = "Date",
    FRIEND = "Friend",
...
export declare enum RiskLevels {
    LOW = "LOW",
    MODERATE = "MODERATE",
    HIGH = "HIGH",
    CRITICAL = "CRITICAL"
}
export declare enum EvidenceQuality {
    STRONG = "Strong",
    MODERATE = "Moderate",
    LIMITED = "Limited"
}

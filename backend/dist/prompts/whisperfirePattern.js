...
exports.PatternProfilingWeapon = void 0;
class PatternProfilingWeapon {
    // ⚙️ PATTERN ENGINE
    static buildPatternPrompt(messages, relationship, tone, personName) {
...
`;
    ...
    static getRelationshipSpecialization(relationship) {
        const specs = {
            'Partner': `
...
- Detect grooming, mirroring, and discard-risk triggers`
        ...
        return specs[relationship] || specs.Friend;
    }
...
- Focus on safety, hope, and empowerment`
        ...
        return tones[tone] || tones.clinical;
    }
}
exports.PatternProfilingWeapon = PatternProfilingWeapon;
// 🔬 PATTERN.AI — BEHAVIORAL STRATEGIST + FORENSIC PROFILER
PatternProfilingWeapon.PATTERN_CORE = `
...
`;
//# sourceMappingURL=whisperfirePattern.js.map